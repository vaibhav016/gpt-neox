...
class NeoXArgsTraining(NeoXArgsTemplate):
    ...
    replay_idx_paths_prefixes: list = None
    """
    ...
    replay_data_to_idx_paths: dict = None
    """
    ...
    replay_reshuffle_idx: bool = True
    """
