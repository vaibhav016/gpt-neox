...
# Define variables
CHECKPOINT_DIR="checkpoints/dclm/inf_cos/low"
...
sed -i "s|\"load\":.*|\"load\": \"${CHECKPOINT_PATH}\",|" configs/load_checkpoints/dclm/inf_cos/load_low.yml

# Run the training script
python deepy.py train.py --conf_dir configs llama2/410M.yml dataset_config/dclm/dclm_config_scratch.yml schedulers/inf_cos/adam_infcos_lr3e-4_3e-5_wu-001_const_4.yml load_checkpoints/dclm/inf_cos/load_low.yml &                  
PYTHON_PID=$!
