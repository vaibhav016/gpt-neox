...
python $TRAIN_PATH/deepy.py $TRAIN_PATH/train.py --conf_dir $TRAIN_PATH/configs summit_vaib-1-3B.yml summit_setup.yml vaibhav_schedules/cosine_decay_schedules/adam_cosine_lr3e-4_3e-5_wu-0.01.yml
