...
python deepy.py train.py --conf_dir configs llama2/410M.yml dataset_config/german/german_config_scratch.yml schedulers/inf_cos/ablation_const_low/adam_infcos_lr3e-4_3e-5_wu-001_const_1p75.yml load_checkpoints/german/3rd_dec/inf_cos/ablations/low/const_1p75/load_low.yml &                        
PYTHON_PID=$!
