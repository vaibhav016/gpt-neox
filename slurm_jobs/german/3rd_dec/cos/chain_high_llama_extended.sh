...
# Define variables
CHECKPOINT_DIR="checkpoints_3rd_dec/german/cos/high"
...
sed -i "s|\"load\":.*|\"load\": \"${CHECKPOINT_PATH}\",|" configs/load_checkpoints/german/3rd_dec/cos/load_high.yml

# Run the training script
python deepy.py train.py --conf_dir configs llama2/410M.yml dataset_config/german/german_config_scratch.yml schedulers/cos/adam_cosine_lr1e-3_3e-5_wu-0.01.yml load_checkpoints/german/3rd_dec/cos/load_high.yml &
PYTHON_PID=$!
...
sed -i "s|\"finetune\":.*|\"finetune\": false,|" configs/load_checkpoints/german/3rd_dec/cos/load_high.yml
