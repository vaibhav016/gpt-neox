#!/bin/bash
#SBATCH --output=/ccs/home/vaibhav_016/bif151/scratch/vaibhav_016/slurm_logs/dclm/cos/high/output/slurm-%j.out            
#SBATCH --error=/ccs/home/vaibhav_016/bif151/scratch/vaibhav_016/slurm_logs/dclm/cos/high/error/slurm-%j.err
...
SECONDS_BEFORE_EXIT=21420  # 5 hour 57 minutes (for a 6-hour job)
...
# Define variables
CHECKPOINT_DIR="checkpoints_3rd_dec/dclm/cos/high"
...
sed -i "s|\"load\":.*|\"load\": \"${CHECKPOINT_PATH}\",|" configs/load_checkpoints/dclm/3rd_dec/cos/load_high.yml

# Run the training script
python deepy.py train.py --conf_dir configs llama2/410M.yml dataset_config/dclm/dclm_config_scratch.yml schedulers/cos/adam_cosine_lr1e-3_3e-5_wu-0.01 load_checkpoints/dclm/3rd_dec/cos/load_high.yml &
PYTHON_PID=$!
