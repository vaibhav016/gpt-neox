#!/bin/bash
#SBATCH --job-name="ger_tr_inf_cos_low_val_pile"
#SBATCH --nodes=1
...
#SBATCH --mem=80G
#SBATCH --time=6:00:00 
#SBATCH --output=ger_tr_inf_cos_low_val_pile-%j.out
#SBATCH --error=ger_tr_inf_cos_low_val_pile-%j.err
...
python3 deepy.py train.py ./configs/49M_local_test_finetune.yml ./configs/german_schedules/pile_valid/local_setup_german_val_pile_low.yml ./configs/schedules/inf_cosine_schedules/adam_infcos_lr_constant_german_low.yml
