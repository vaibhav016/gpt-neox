#!/bin/bash
#SBATCH --job-name="pile_training_cosine_decay_val_ger"
...
#SBATCH --mem=80G
#SBATCH --time=3:00:00 
#SBATCH --output=pile_training_cosine_decay_val_ger-%j.out
#SBATCH --error=pile_training_cosine_decay_val_ger-%j.err
...
python3 deepy.py train.py ./configs/49M_local_test_finetune.yml ./configs/german_schedules/german_valid/local_setup_german_val_ger_cosine_decay.yml ./configs/schedules/adam_cosine_lr3e-3_3e-6_wu-001.yml
