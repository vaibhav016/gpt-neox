...
python deepy.py train.py --conf_dir configs llama2/410M.yml dataset_config/code/code_config_scratch_replay.yml schedulers/const_inf_cos/code/ablation_const_low/adam_constant_lr3e-4_3e-5_wu-0_2p.yml load_checkpoints/code/3rd_dec/inf_cos/ablations/cooldown_proportion_0.6_replay/const_2p/load.yml &                        
PYTHON_PID=$!
