#!/bin/bash
#SBATCH --job-name="ger_tr_inf_cos_medium_val_gr_and_pile"
#SBATCH --nodes=1
...
#SBATCH --output=ger_tr_inf_cos_medium_val_gr_and_pile-%j.out
#SBATCH --error=ger_tr_inf_cos_medium_val_gr_and_pile-%j.err
