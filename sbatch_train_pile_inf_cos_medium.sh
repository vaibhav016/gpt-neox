#!/bin/bash
#SBATCH --job-name="pile_tr_inf_cos_medium_constant_resume"
#SBATCH --nodes=1
...
#SBATCH --mem=80G
#SBATCH --time=1:00:00 
#SBATCH --output=pile_tr_inf_cos_medium_constant_resume-%j.out
#SBATCH --error=pile_tr_inf_cos_medium_constant_resume-%j.err
...
python deepy.py train.py ./configs/49M_local_test.yml ./configs/pile_schedules/constant_train/local_setup_pile_train_const_medium.yml ./configs/schedules/constant_schedules/adam_constant_lr1.6e-4_wu-0_medium.yml
