...
python deepy.py train.py --conf_dir configs llama2/410M.yml dataset_config/code/code_config_scratch.yml schedulers/cos/code/adam_cosine_lr1e-3_3e-5_wu-0.01 load_checkpoints/code/3rd_dec/cos/load_high.yml &
PYTHON_PID=$!
