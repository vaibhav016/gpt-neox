...
python $TRAIN_PATH/deepy.py $TRAIN_PATH/train.py --conf_dir $TRAIN_PATH/configs summit_vaib-1-3B.yml vaibhav_german_setup/summit_setup_inf_inv.yml vaibhav_schedules/constant_schedules/adam_const_inf_inv_lr1.6e-5_wu-0_low.yml
