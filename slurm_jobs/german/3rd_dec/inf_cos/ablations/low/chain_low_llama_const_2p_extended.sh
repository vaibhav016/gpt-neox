...
python deepy.py train.py --conf_dir configs llama2/410M.yml dataset_config/german/german_config_scratch.yml schedulers/const_inf_cos/ablation_const_low/adam_constant_lr3e-4_3e-5_wu-0_2p.yml load_checkpoints/german/3rd_dec/inf_cos/ablations/low/const_2p/load_low.yml &                        
PYTHON_PID=$!
