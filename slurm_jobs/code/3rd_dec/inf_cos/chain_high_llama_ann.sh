#!/bin/bash
#SBATCH --output=/ccs/home/vaibhav_016/bif151/scratch/vaibhav_016/slurm_logs/code/inf_cos/high/output/slurm-%j.out            
#SBATCH --error=/ccs/home/vaibhav_016/bif151/scratch/vaibhav_016/slurm_logs/code/inf_cos/high/error/slurm-%j.err
...
# Define variables
CHECKPOINT_DIR="checkpoints_3rd_dec/code/inf_cos/high"

# # Get the most recent checkpoint path
# LATEST_CHECKPOINT="${CHECKPOINT_DIR}/JOB-2977956__it-47684_wu-0_mxlr-0.0005_mnlr-0.0_sch-constant_tr-code-train_resume"
...
sed -i "s|\"load\":.*|\"load\": \"${CHECKPOINT_PATH}\",|" configs/load_checkpoints/code/3rd_dec/inf_cos/load_high.yml

# Run the training script
python deepy.py train.py --conf_dir configs llama2/410M.yml dataset_config/code/code_config_scratch.yml schedulers/const_inf_cos/code/annealing/adam_constant_lr5e-4_wu-0_high.yml load_checkpoints/code/3rd_dec/inf_cos/load_high.yml                       
...
sed -i "s|\"finetune\":.*|\"finetune\": false,|" configs/load_checkpoints/code/3rd_dec/inf_cos/load_high.yml
