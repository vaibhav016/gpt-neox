...
python $TRAIN_PATH/deepy.py $TRAIN_PATH/train.py --conf_dir $TRAIN_PATH/configs pythia/410M.yml vaibhav_sp_sep_dom/book.yml vaibhav_schedules/cosine_decay_schedules/adam_cosine_lr3e-4_3e-5_wu-0.01.yml checkpoint_paths/sp_sep_dom_cos_small.yml
