...
python3 deepy.py train.py ./configs/49M_local_test.yml ./configs/german_schedules/pile_valid/local_setup_german_val_pile_medium.yml ./configs/schedules/constant_schedules/adam_constant_lr1.6e-4_wu-0_medium.yml
