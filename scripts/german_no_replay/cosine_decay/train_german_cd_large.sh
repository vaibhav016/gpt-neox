...
python $TRAIN_PATH/deepy.py $TRAIN_PATH/train.py --conf_dir $TRAIN_PATH/configs summit_vaib-1-3B.yml vaibhav_german_setup/summit_setup_cos.yml vaibhav_schedules/cosine_decay_schedules/adam_cosine_lr3e-4_3e-6_wu-0.01.yml
