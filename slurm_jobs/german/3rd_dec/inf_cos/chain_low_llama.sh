...
python deepy.py train.py --conf_dir configs llama2/410M.yml dataset_config/german/german_config_scratch.yml schedulers/const_inf_cos/adam_constant_lr1.5e-4_wu-0_low.yml load_checkpoints/german/3rd_dec/inf_cos/load_low.yml &                  
PYTHON_PID=$!
