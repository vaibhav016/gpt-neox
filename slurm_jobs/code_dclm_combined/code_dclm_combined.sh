#!/bin/bash
#SBATCH --output=/ccs/home/vaibhav_016/bif151/scratch/vaibhav_016/slurm_logs/code_dclm_combined/output/slurm-%j.out            
#SBATCH --error=/ccs/home/vaibhav_016/bif151/scratch/vaibhav_016/slurm_logs/code_dclm_combined/error/slurm-%j.err
...
# Define variables
CHECKPOINT_DIR="checkpoints_3rd_dec/code_dclm_combined"
...
sed -i "s|\"load\":.*|\"load\": \"${CHECKPOINT_PATH}\",|" configs/load_checkpoints/code_dclm_combined/load.yml

# Run the training script
python deepy.py train.py --conf_dir configs llama2/410M_code_dclm_combined.yml dataset_config/code_dclm_combined/code_dclm_scratch.yml schedulers/cos/adam_cosine_lr3e-4_3e-5_wu-0.01.yml load_checkpoints/code_dclm_combined/load.yml &                        
PYTHON_PID=$!
...
sed -i "s|\"finetune\":.*|\"finetune\": false,|" configs/load_checkpoints/code_dclm_combined/load.yml
