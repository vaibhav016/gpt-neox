...
# Define variables
CHECKPOINT_DIR="checkpoints_3rd_dec/code/inf_cos/ablations/low/const_1p"
...
sed -i "s|\"load\":.*|\"load\": \"${CHECKPOINT_PATH}\",|" configs/load_checkpoints/code/3rd_dec/inf_cos/ablations/low/const_1p/load_low.yml

# Run the training script
python deepy.py train.py --conf_dir configs llama2/410M.yml dataset_config/code/code_config_scratch.yml schedulers/const_inf_cos/code/ablation_const_low/adam_constant_lr3e-4_3e-5_wu-0_1p.yml load_checkpoints/code/3rd_dec/inf_cos/ablations/low/const_1p/load_low.yml &                        
PYTHON_PID=$!
