...
bkill 3199123
python /gpfs/alpine/csc499/scratch/btherien/experiments_phase_2/7-1B_future_launch_sp_scratch.py --job-id $LSB_JOBID --sleep-time 9 &
...
python $TRAIN_PATH/deepy.py $TRAIN_PATH/train.py --conf_dir $TRAIN_PATH/configs pythia_410m_llama_setup_resume.yml iclr_models/7_1B.yml datasets/val/pile_slimp_domains.yml datasets/train/slim_pajama_300B.yml load/resume_1-2e-4_001_7-1B_slim_pajama_PT.yml schedules/adam_cosine_lr1-2e-4_1-2e-5_wu-001.yml
