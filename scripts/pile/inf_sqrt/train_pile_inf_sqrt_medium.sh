...
python $TRAIN_PATH/deepy.py $TRAIN_PATH/train.py --conf_dir $TRAIN_PATH/configs summit_vaib-1-3B.yml summit_setup.yml vaibhav_schedules/inf_inverse_sqrt_schedules/adam_infinv_lr3e-3_3e-6_wu-0.01_medium.yml
