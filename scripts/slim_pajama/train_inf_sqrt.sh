...
python $TRAIN_PATH/deepy.py $TRAIN_PATH/train.py --conf_dir $TRAIN_PATH/configs pythia/410M.yml vaibhav_slim_pajama/summit_setup_inf_inv.yml vaibhav_schedules/inf_inverse_sqrt_schedules/adam_infinv_lr3e-3_3e-5_wu-0.01.yml
