...
# LATEST_CHECKPOINT="${CHECKPOINT_DIR}/JOB-2990416__it-47684_wu-0_mxlr-0.00015_mnlr-0.0_sch-constant_tr-code-train_resume"
...
python deepy.py train.py --conf_dir configs llama2/410M.yml dataset_config/code/code_config_scratch.yml schedulers/const_inf_cos/code/annealing/adam_constant_lr1.5e-4_wu-0_low.yml load_checkpoints/code/3rd_dec/inf_cos/load_low.yml &                  
PYTHON_PID=$!
