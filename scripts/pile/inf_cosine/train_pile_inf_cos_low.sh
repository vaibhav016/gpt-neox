...
python $TRAIN_PATH/deepy.py $TRAIN_PATH/train.py --conf_dir $TRAIN_PATH/configs summit_vaib-1-3B.yml summit_setup.yml vaibhav_schedules/inf_cosine_schedules/adam_infcos_lr3e-3_3e-6_wu-001_low.yml
