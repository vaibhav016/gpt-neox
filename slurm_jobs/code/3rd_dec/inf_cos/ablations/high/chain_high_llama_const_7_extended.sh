...
python deepy.py train.py --conf_dir configs llama2/410M.yml dataset_config/code/code_config_scratch.yml schedulers/const_inf_cos/code/ablation_const_high/adam_constant_lr1e-3_3e-5_wu-0_7.yml load_checkpoints/code/3rd_dec/inf_cos/ablations/high/const_7/load_high.yml &                        
PYTHON_PID=$!
