...
#SBATCH -A bif151
#SBATCH -J llama_german_cos_high
#SBATCH -t 24:00:00
#SBATCH -p batch
#SBATCH -N 300
...
python deepy.py train.py --conf_dir configs llama2/410M.yml dataset_config/german/german_config_scratch.yml schedulers/cos/adam_cosine_lr1e-3_3e-5_wu-0.01.yml                                  
