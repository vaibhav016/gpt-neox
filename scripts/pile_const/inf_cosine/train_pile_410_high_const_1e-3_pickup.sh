...
python $TRAIN_PATH/deepy.py $TRAIN_PATH/train.py --conf_dir $TRAIN_PATH/configs pythia/410M.yml summit_setup_pickup.yml vaibhav_schedules/constant_schedules/adam_const_inf_inv_lr1.6e-5_wu-0_low.yml checkpoint_paths/pile_scratch_const_high.yml
