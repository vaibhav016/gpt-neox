...
# Define variables
CHECKPOINT_DIR="checkpoints_3rd_dec/dclm/inf_cos/ablations/low/const_1p"
...
sed -i "s|\"load\":.*|\"load\": \"${CHECKPOINT_PATH}\",|" configs/load_checkpoints/dclm/3rd_dec/inf_cos/ablations/low/const_1p/load_low.yml

# Run the training script
python deepy.py train.py --conf_dir configs llama2/410M.yml dataset_config/dclm/dclm_config_scratch.yml schedulers/inf_cos/ablation_const_low/adam_infcos_lr3e-4_3e-5_wu-001_const_1p.yml load_checkpoints/dclm/3rd_dec/inf_cos/ablations/low/const_1p/load_low.yml &                        
PYTHON_PID=$!
