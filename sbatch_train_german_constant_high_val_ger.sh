...
python3 deepy.py train.py ./configs/49M_local_test.yml ./configs/german_schedules/german_valid/local_setup_german_val_ger_high.yml ./configs/schedules/constant_schedules/adam_constant_lr1.6e-3_wu-0_high.yml
