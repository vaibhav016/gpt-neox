...
python deepy.py train.py --conf_dir configs llama2/410M.yml dataset_config/dclm/dclm_config_scratch.yml schedulers/linear/adam_linear_lr3e-4_3e-5_wu-001.yml                                 
