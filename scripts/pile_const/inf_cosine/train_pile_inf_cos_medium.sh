...
python $TRAIN_PATH/deepy.py $TRAIN_PATH/train.py --conf_dir $TRAIN_PATH/configs summit_vaib-1-3B.yml summit_setup_pile_const_inf_cos.yml vaibhav_schedules/constant_schedules/adam_constant_lr1.6e-5_wu-0_low.yml 
