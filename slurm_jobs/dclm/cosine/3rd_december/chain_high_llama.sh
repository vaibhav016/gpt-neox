...
# Define variables
CHECKPOINT_DIR="checkpoints/dclm/cosine/high"
...
sed -i "s|\"load\":.*|\"load\": \"${CHECKPOINT_PATH}\",|" configs/load_checkpoints/dclm/inf_cos/load_flash.yml

# Run the training script
python deepy.py train.py --conf_dir configs llama2/410M.yml dataset_config/dclm/dclm_config_scratch.yml schedulers/cos/adam_cosine_lr3e-4_3e-5_wu-0.01.yml load_checkpoints/dclm/cosine/load_high.yml &
PYTHON_PID=$!
