...
python $TRAIN_PATH/deepy.py $TRAIN_PATH/train.py --conf_dir $TRAIN_PATH/configs pythia/410M.yml vaibhav_sp_sep_dom/common_crawl.yml vaibhav_schedules/inf_cosine_schedules/adam_infcos_lr3e-4_3e-5_wu-001_const_4.yml checkpoint_paths/sp_sep_dom_inf_cos_small.yml
