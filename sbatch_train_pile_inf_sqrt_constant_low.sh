...
python deepy.py train.py ./configs/49M_local_test.yml ./configs/local_setup_pile_train_const_low.yml ./configs/schedules/constant_schedules/adam_constant_lr1.6e-5_wu-0_low.yml
