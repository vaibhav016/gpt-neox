...
python deepy.py train.py --conf_dir configs llama2/410M.yml dataset_config/code/code_config_scratch.yml schedulers/const_inf_cos/code/adam_constant_lr5e-4_wu-0_high.yml load_checkpoints/code/3rd_dec/inf_cos/load_high.yml                     
