#!/bin/bash
#SBATCH --job-name="pile_tr_infcos_constant_low"
...
#SBATCH --mem=80G
#SBATCH --time=3:00:00 
#SBATCH --output=pile_tr_infcos_constant_low.out
#SBATCH --error=pile_tr_infcos_constant_low.err
...
python deepy.py train.py ./configs/49M_local_test_finetune.yml ./configs/pile_schedules/constant_train/local_setup_pile_train_const_low.yml ./configs/schedules/constant_schedules/adam_constant_lr1.6e-5_wu-0_low.yml
