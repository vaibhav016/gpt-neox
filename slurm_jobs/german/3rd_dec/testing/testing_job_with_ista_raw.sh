...
python deepy.py train.py --conf_dir configs 2nd_dec_testing_flash/410M_ista_changes.yml dataset_config/dclm/dclm_config_scratch.yml schedulers/inf_cos/adam_infcos_lr1e-3_3e-5_wu-001_const_5.yml load_checkpoints/dclm/inf_cos/load_flash.yml                     
