...
python deepy.py train.py --conf_dir configs llama2/410M.yml dataset_config/dclm/dclm_config_scratch.yml schedulers/inf_cos/adam_infcos_lr3e-3_3e-5_wu-001_const_5.yml load_checkpoints/dclm/3rd_dec/inf_cos/load_high.yml &                        
PYTHON_PID=$!
