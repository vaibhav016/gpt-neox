#!/bin/bash
#SBATCH --output=/ccs/home/vaibhav_016/bif151/scratch/vaibhav_016/slurm_logs/code/cos/high/output/slurm-%j.out            
#SBATCH --error=/ccs/home/vaibhav_016/bif151/scratch/vaibhav_016/slurm_logs/code/cos/high/error/slurm-%j.err
...
SECONDS_BEFORE_EXIT=86100  # 5 hour 57 minutes (for a 6-hour job)
...
# Define variables
CHECKPOINT_DIR="checkpoints_3rd_dec/code/cos/high"
...
sed -i "s|\"load\":.*|\"load\": \"${CHECKPOINT_PATH}\",|" configs/load_checkpoints/code/3rd_dec/cos/load_high.yml

# Run the training script
python deepy.py train.py --conf_dir configs llama2/410M.yml dataset_config/code/code_config_scratch.yml schedulers/cos/code/adam_cosine_lr1e-3_3e-5_wu-0.01.yml load_checkpoints/code/3rd_dec/cos/load_high.yml &
PYTHON_PID=$!
...
sed -i "s|\"finetune\":.*|\"finetune\": false,|" configs/load_checkpoints/code/3rd_dec/cos/load_high.yml
