...
python $TRAIN_PATH/deepy.py $TRAIN_PATH/train.py --conf_dir $TRAIN_PATH/configs pythia/410M.yml summit_setup_slim_pajama.yml vaibhav_schedules/inf_cosine_schedules/adam_infcos_lr1e-3_3e-5_wu-001_const_5.yml
