...
python deepy.py train.py --conf_dir configs llama2/410M.yml dataset_config/code/code_config_scratch.yml schedulers/const_inf_cos/code/annealing/ablation_const_low/adam_constant_lr3e-4_3e-5_wu-0_1p25.yml load_checkpoints/code/3rd_dec/inf_cos/ablations/low/const_1p25/load_low.yml &                        
PYTHON_PID=$!
