#!/bin/bash
GPUS_PER_NODE=4
mkdir -p /home/pmehrbod/projects/def-eugenium/pmehrbod/gpt-neox/hostfiles
# need to add the current slurm jobid to hostfile name so that we don't add to previous hostfile
hostfile=/home/pmehrbod/projects/def-eugenium/pmehrbod/gpt-neox/hostfiles/hosts_$SLURM_JOBID
