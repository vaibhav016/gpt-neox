...
python $TRAIN_PATH/deepy.py $TRAIN_PATH/train.py --conf_dir $TRAIN_PATH/configs pythia/410M.yml vaibhav_sp_sep_dom/arxiv.yml vaibhav_schedules/constant_schedules/adam_constant_lr1.6e-3_wu-0_high.yml checkpoint_paths/sp_sep_dom_inf_cos_high
