#!/bin/bash
GPUS_PER_NODE=8
mkdir -p /lustre/orion/bif151/scratch/vaibhav_016/neox/gpt-neox/hostfiles
# need to add the current slurm jobid to hostfile name so that we don't add to previous hostfile
hostfile=/lustre/orion/bif151/scratch/vaibhav_016/neox/gpt-neox/hostfiles/hosts_$SLURM_JOBID
